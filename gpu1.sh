...
python3 main.py --device 1 --model gan_feat_stored --adv --adv_type hinge --optimizer adam --lr 1e-4 --joint --cls_w 1 --phase_2 --gen_lr_factor 1;
python3 main.py --device 1 --model gan_feat_stored --adv --adv_type hinge --optimizer adam --lr 1e-4 --cls_w 1 --phase_2 --gen_lr_factor 1;
python3 main.py --device 1 --model gan_feat_stored --adv --adv_type hinge --optimizer adam --lr 1e-4 --joint --cls_w 0.1 --phase_2 --gen_lr_factor 1;
python3 main.py --device 1 --model gan_feat_stored --adv --adv_type hinge --optimizer adam --lr 1e-4 --cls_w 0.1 --phase_2 --gen_lr_factor 1;
